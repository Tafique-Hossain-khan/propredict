...
from src.laptop_price.pipeline.prediction_pipeling import CustomInputLaptop,PredictPipeline 
...
if __name__ == "__main__":
    ...
    try:
        ...
        pred.predict(df)
        '''
        preprocessor = load_object('artifacts/laptop/prep.pkl')
        model = load_object('artifacts/laptop/mod.pkl')
